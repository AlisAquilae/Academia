...
The difference between a solid and a fluid can be introduced from a comparison between pudding. When tilted, pudding will deform over a fixed distance. In more formal terms, it reacts to a [[Shear Force]] with a fixed deformation. It is therefore a solid. A [[Fluid]], on the other hand, reacts to shear force with a continuous deformation. This deformation is called the [[Shear Strain]]. The rate of deformation is referred to as the [[Rate of Strain]], or, in the context of shear stress, the [[Shear Rate]]. This rate, $\dot{\gamma}$ ,  