...
Key to this origin is the fact that where a river [[Debouchment|Debouches]] into a sea or lake, the sediments carried by the river are deposited near the mouth, because of the more or less sudden reduction of the ability of the flow to carry sediments. Over time, a particularly submerged, seaward growing sediment body is formed near the river mouth. Starting from this depositional process, geologists and geomorphologists have a slightly different focus when studying the delta phenomenon.
...
Natural levees form along delta river channels by overbank deposition of sandy and silty clay. Natural levee deposits may form on top of channel deposits, e.g. after lateral migration of the channel, or form on top of other fluvial deposits, e.g. floodbasin deposits. Natural levee deposits may show a fining upward sequence associated with vertical growth of the natural levee relative to mean flood levels. Natural levee deposits thin away from the channel and wedge out in the lateral lower-lying floodbasins, which traps the finest clayey sediments during prolonged annual flooding. 
...
>[!Info]
>In arid climates, lagoons may develop into salt pans with a hypersaline top soil, due to high evapotranspiration. 
...
2. In tidal channel systems either ebb or flood currents are dominant, due to asymmetry of the tidal wave
...
### 1.4.2.3 Offshore
When deltas form in shallow water, i.e. the water depth of the receiving basin is not much deeper than the river channel, then the offshore delta environment is in fact a seaward extension of the coastal zone that is dominated by wave processes and tidal currents. Such a subaqueous coastal slope is usually called a [[Shoreface]]. The Rhine-Meuse delta is an example of shallow-water delta with a very limited offshore extension only consisting of a shoreface 

When deltas form in deep water the offshore delta environments become much more extensive and extend far below the shoreface zone that is influenced by the waves. In this deeper offshore zone, termed the [[Delta Front]], different sedimentary environments exist and there is a number of sedimentary processes that redistribute the sediments supplied by the river delta.

The slope of the subaqueous delta front is one of the most important variables determining the different redistribution processes. The slope of the delta front depends stronglt on the grain size of the sediments supplied by the river. When this material is gravelly, the slope of the delta front is steep, up to $30\degree$. More gentle slopes generally in the range of $1-10\degree$ are associated with sand-sized material. Low delta slopes of $0.01$ to $1\degree$ usually exist in silty material. The subaqueous delta slope is often concave because of downslope fining of the sediments. Many deltas also have a delta front platform, a more or less flat shallow-marine surface between the coastline and the break in slope marking the trandition to the delta front proper. 

When the delta front becomes too steep, mass failure may lead to redistribution of sediments. These processes and the angle of slope instability depend strongly on the grain size. In gravelly sediments debris flows may occur, whereas in silty and sandy sediments turbidity currents are important. Mud flows dominate in clayey delta slope deposits. These redistribution processes create a complex subaqueous morphology of gullies, channels and depositional lobes. Even greater complexity may arise from later deformation processes, such as the formation of mud diapirs. These form, for example, in the Mississippi delta upon rapid loading of poorly consolidated prodelta clays with thick coarser delta front deposits. The squeezed soft clays then locally break through the overlying deposits and may reach the surface to form sea-floor mounds or even islands. 
