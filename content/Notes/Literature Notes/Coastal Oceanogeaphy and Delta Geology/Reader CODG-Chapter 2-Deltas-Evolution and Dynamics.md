...
---
# 2.1 Introduction
Geologically speaking, natural [[Delta|Deltas]] are very dynamic landscapes. The delta rivers continuously deposit sediments on the delta plain, while the channels may laterally migrate across the plain by bank erosion and deposition of lateral bars. From time to time, the delta rivers more or less suddenly shift to a completely new position on the delta plain, a process which is called [[Avulsion]]. At and near the river mouth new land is formed, which leads to channel extension. Longshore [[Coastal Sediment Transport|marine transport of sediments]] and [[Aeolian Sediment Transport|aeolian processes]] facilitate formation of beach ridges. Salt marshes in the sheltered [[Lagoon|Lagoons]] or other parts of the delta coast gradually grow upward by trapping fine sediments. On the other hand, waves may attack and erode beach ridges and salt marshes, and tidal channel systems may erosively expand inland. Additionally, parts of the delta plain that receive little sediment gradually drown because of slow subsidence, potentially aided by sea-level rise. Drowning is followed by intensification of marine erosion.

![[Pasted image 20250215130515.png]]


The schematic of delta dynamics above describes the overlapping growth and decline of delta lobes, a result of constructive and destructive forces that may continuously change in space and time. This can be thought of as the "Delta Cycle":
- The constructive forces are [[Fluvial Sediment Transport|fluvial]] sediment influx and deposition (or redeposition) by fluvial, marine and aeolian processes
- The destructive forces are marine erosion by waves and tidal currents, and subsidence and sea-level rise

Central to the constructive forces of delta evolution is the process of [[Avulsion]]. Avulsion determines the location of a river channel and its mouth, which importantly determines which part of the delta receives enough sediment to grow. Understanding the causes and mechanisms of avulsion is the key to understanding delta evolution on the millennia timescale. 

The destructive forces of delta evolution are strongly influenced by relative land-level lowering, which on its turn is determined by sea-level change and subsidence. Relative land-level lowering, which in itself already causes degradation of the sub-aerial delta, makes the delta vulnerable for the destructive marine forces of wave and tidal current erosion.

Before we can discuss the constructive and destructive forces of delta formation in depth, some general principles of delta evolution need to be outlined. 

>[!Important]
>A key concept is that delta formation is finely tuned to the position of base level


---
# 2.2 Base-Level Changes and Delta Evolution
...
The sediment body formed under influence of sea-level rise thins in an up-stream direction. Its most inland occurrence is the apex of the delta and is also called the Terrace Incision Point. This is the point where the fluvial terraces that are underlying the delta sediment body emerge at the surface. Upstream of this point the river floodplain is confined by these terraces that increasingly rise above the present floodplain in an upstream direction, forming valley sides. With rising sea level the terrace intersection point will migrate upstream, due to morphological backwater effects, and terraces downstream of this point become gradually covered by young fluvial delta deposits. In the Rhine-Meuse delta the terrace intersec5tion point of the Rhine has shifted inland from a position near Rotterdam at 8000 years BP to its present position near the German border.
...
In natural deltas, the delta surface is aggrading by annual flooding and sediment deposition. This aggradation rate typically ranges between 1 and 3 mm/year, but is strongly variable in space and time. Remote parts of the delta surface may receive no sediment for long periods of time, while natural levees and crevasse splays receive each year centimeters thick of fresh sediment. As explained above, avulsion dynamics rule the sediment distribution on the delta plain. In our equation deposition ($D$) has a positive sign

Sediment compaction may cause dramatic changes in sediment volume. The process of compaction involves the decreasing of pore space in sediments and peat, leading to a change in total water volume. Pore space may decrease because of the loading with new sediments, the rearrangement of sediment particles with time (sediment consolidation), and the decline of pore pressure because of fluid or gas extraction. The latter is usually a result of human activities, i.e. mining of oil, gas or groundwater. One can distinguish between shallow and deep compaction. Shallow compaction is usually caused by dewatering of young sediments at the surface. This may be a natural process, for instance in tidal marshes, where rapidly deposited muds gradually lose pore water because of drying during parts of the tidal cycle, while loading by annual deposition of fresh sediment layers may play a role as well. Shallow compaction may also be a result of artificial drainage and loading, related to human land use and construction activities. Shallow compaction commonly takes place at the timescale of decades to centuries. Deep compaction refers to the, often long-term, processes of volume decrease of deeply buried sediment beds, for example prodelta muds beneath a prograding delta complex. Deep compaction may go on for millennia. In our equation compaction ($C$), including shallow and deep compaction, has a negative sign

>[!Question]
>But the sign is positive?????

A slightly different process that often goes together with shallow compaction is oxidation. Organic sediment or peat rapidly loses mass when exposed to the air, because its carbon reacts with $\ce{O2}$ to produce $\ce{CO2}$ which is lost to the air. The problem of oxidation of peatlands in deltas emerges when natural wetlands are drained for agricultural land use. In the Rhine-Meuse delta this is a serious problem: more than 5 m of land-level lowering in some parts of the Western delta plain since the Middle Ages is primarily caused by drainage-related oxidation, with the process continuing today at rates of up to 5 mm/year. In our equation, the land-level lowering due to oxidation ($O$) has a negative sign

Local or regional loading of the Earth's crust may result in differential movement of the surface. In the case of delta formation, local loading may result from sediment deposition associated with delta lobe formation. In this case the crust is depressed by the delta sediment body, whereas rearrangement of material in the shallow mantle will cause a slight rise of the crust in the surrounding areas. Loading of the crust by ocean water or ice will basically have a comparable effect. Alternatively, if the load is removed the once depressed crust will rise again, whereas the peripheral area will drop. For example, the formation and decay of land ice masses in the Pleistocene have given rise to large regional isostatic movements. These movements may continue for millennia after ice sheets have disappeared. Because of these strong differential movements, deltas in formerly glaciated regions may actually undergo uplift, in spite of compaction and crustal loading. The Holocene sea-level history of the Rhine-Meuse delta, in the peripheral zone of the Weichselian Scandinavian ice sheet, has been profoundly influenced by isostatic lowering of the  crust after ice sheet decay, resulting in an Early-Holocene rate of relative sea-level rise strongly exceeding the world-wide eustatic rates. In our equation, land-level lowering due to differential isostatic movements ($I$) has a negative sign.

Finally, the position of the delta surface may be influenced by tectonic movements, occurring along faults in the subsurface. Deltas are most commonly located in tectonically subsiding areas associated with crustal extension. The Rhine-Meuse delta, for example, is partly underlain by graben structures. Old and inactive tectonic structures may sometimes also be reactivated by isostatic forces. In our equation, land-level lowering due to tectonic movements ($T$) has a negative sign.

It will be clear from the above that the vertical position of the delta plain represents a fragile balance of many geological forces. Often the different components of subsidence are not known individually and the same holds for the local variations in sea-level rise. What the equation for sea-level change relative to the delta surface shows is that the fragile balance can be disturbed in many ways. Even without human influence, many factors contribute to relative delta sinking, while few of them work in the opposite way. This fact makes deltas vulnerable in their natural state already. However, nowadays human activities have dramatically altered the balance, through fundamental changes in multiple factors that contribute to delta sinking. 