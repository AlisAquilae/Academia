...
- Knowledge on forest imopact on streamflow
- Simple mathematical model
- How do forests impact not just streamflow but also the atmosphere

---
# Water and trees
Water and energy balance are coupled. 

Trees help with climate change, but what is effect on water?

Trees are different from most types of vegetation due to the large canopy. From hydrological POV. High area where rainfall can be intercepted and where it can transpire. Also deeper roots, meaning it can evaporate longer. They are also higher up in the atmosphere, exposed to drier air, more evapotranspiration. All increases evapotranspiration. 

Short vegetation driven by available energy, for trees this is not the case. 

So: trees are different
