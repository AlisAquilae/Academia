...
---
# Intro
Today: Forms and deposits

Review:
- In geomorphology, surface characteristics and processes are of importance

River energy is decreasing due to damming and land use changes. 

Management decisions are key to delta sustainability
...
Most commonly facies are distinguished on grain size (sand, mud) and sedimentary structures (type of lamination/bedding)

Sedimentary facies can be coupled to sedimentary environments, areas ruled by a specific set of sedimentary processes (very often sedimentary environments similar to geomorphological units)
