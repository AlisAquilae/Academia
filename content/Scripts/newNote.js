async function newNote() {
    ...
    if (tp.file.path(true).includes(".jpg") || tp.file.path(true).includes(".png")) {
        ...
        course = await tp.system.suggester(["Advanced Hydrological Systems Analysis", "Water and Air Flow Numerical Techniques"], ["Advanced Hydrological Systems Analysis", "Water and Air Flow Numerical Techniques"], true);
